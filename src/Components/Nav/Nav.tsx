...
export default function Nav(props: {
  ...
  const [notiBlock, setNotiBlock] = useState(false);
          ...
          <>
            ...
            <div className="navUser">
              ...
              <div className="navNotifications">
                <div
                  className="navButton"
                  onClick={() => setNotiBlock(!notiBlock)}
                >
                  <svg
                    width="20"
                    height="20"
                ...
                <div className={`ProfileBlock${notiBlock ? " PBShow" : ""}`}>
                  <div className="BlockContent">
                    <p className="nP">შეტყობინებები</p>
                    <div className="Line"></div>
                    <div className="NotificationsRow">
                      <div className="Notification">
                        <img src={user} />
                        <div className="NotificationInfo">
                          <p className="NUser">გიორგი</p>
                          <p className="NDesc">
                            გიორგი -მ გამოაქვეყნა ახალი პოსტი
                          </p>
                        </div>
                        <div className="NTime">22:30</div>
                      </div>
                      <div className="Notification">
                        <img src={user} />
                        <div className="NotificationInfo">
                ...
                <div className={`ProfileBlock${profBlock ? " PBShow" : ""}`}>
                  <div className="BlockContent">
                    ...
                    <div className="BlockOptions">
                      ...
                      <button
                        className="BlockB"
                        onClick={() => props.setSession({ loggedIn: false })}
                      >
